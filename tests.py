...
20
"""
comp.load(ias.translate(test_simple_addition))
comp.run()
...
20
"""
comp.load(ias.translate(test_simple_mult))
comp.run()
...
"""
ans = []
translated = ias.translate(test_array_addition)
for i in range(1000):
    a,b = rand(40),rand(40)
...
"""
ans = []
translated = ias.translate(test_array_mult)
for i in range(500):
    a,b = rand(40),rand(40)
    ans.append(a*b)
    translated[500+i] = a
